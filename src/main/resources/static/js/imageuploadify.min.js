      ...
      `);
          ...
          <div class='imageuploadify-details'>
            ...
            $(self).closest("form").on("submit", function(event) {
                ...
                if(totalFiles.length==chkArray.length) {
                    email = $('#email').val();
                    ...
                    for (var i = 0; i < chkArray.length; i++) {
                        formData.append("typefileout", chkArray[i]);
                    }
                    var xhr = new XMLHttpRequest();
                    xhr.open("POST", "/uploadDoc");
                    xhr.onload = function() {
                        console.log(xhr.responseText);
                       // var response = JSON.parse(xhr.responseText);
                        var  FileUploadInput = document.querySelector('#resultupload');
                            FileUploadInput.innerHTML = xhr.responseText;
