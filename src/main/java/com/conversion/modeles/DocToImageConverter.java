...
public class DocToImageConverter extends Converter {

	public DocToImageConverter(InputStream inStream, OutputStream outStream, boolean showMessages, boolean closeStreamsWhenComplete) {
	...
	public void convert() throws Exception{
		...
		Docx4J.toFO(settings, outStream, Docx4J.FLAG_NONE);
